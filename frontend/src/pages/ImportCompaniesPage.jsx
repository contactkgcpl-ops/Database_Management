                                        ...
                                        return (
                                            <tr key={row.row_id || i} className={!isValid ? "has-issues" : ""}>
                                                ...
                                                <td className="issues-column">
                                                    {isValid ? (
                                                        <span className="success-stats-text" style={{ fontSize: "12px", fontWeight: "600", color: "#16a34a" }}>Validation cleared! Ready to import.</span>
                                                    ) : (
                                                ...
                                                {csvData.headers.map(h => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            {renderCellEditor(i, h, val, row, fieldKey)}
                                                        </td>
                                                    );
                                                })}
